    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            fields.forEach(function(field) {
                ...
                if (!fieldError && field.type === 'email' && field.value.trim()) {
                ...
                if (!fieldError && field.type === 'tel' && field.value.trim()) {
                ...
                if (!fieldError && field.hasAttribute('minlength') && field.value.trim()) {
                    var minLength = parseInt(field.getAttribute('minlength'));
                    if (field.value.trim().length < minLength) {
                        fieldError = 'Minimum ' + minLength + ' characters required';
                    }
                }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '36d82885-9543-468a-a378-7b582cc86b92',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '36d82885-9543-468a-a378-7b582cc86b92';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '36d82885-9543-468a-a378-7b582cc86b92';
